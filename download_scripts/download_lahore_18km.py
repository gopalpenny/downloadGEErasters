...
path_params = {
    'shapefile_name' : "lahore_18km", # name of shapefile (without .shp) (contains a single polygon)
    'shapefile_directory' : "/Users/gopal/Google Drive/_Research/Research projects/ML/download_gee_rasters/lahore_18km/lahore_18km_shp", # local path to shapefile directory
...
date_params = {
    ...
    'end_date' : '2023-01-01', # end date for imagery download
